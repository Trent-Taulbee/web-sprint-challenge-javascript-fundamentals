...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
// Internal is being passed along further into the function just as your parents passed DNA down to you. Information can be passed down, but cannot be passed up.
...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const lowNamesMap = array.map((element) => {
  ...
  */
  ...
  function USApop(array){
    const animalPop = array.reduce((accumulator, currentValue) => { 
...
function greeting(firstName, lastName){
  ...
  console.log(greeting("Trent", "Taulbee"));
